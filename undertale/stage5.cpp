...
void stage5::itemSet()
{
	//40 360
	//280
	/*INIDATA->addData("거미 사이다", "설명", "거미를 갈아서 만든 즙과 사이다를 쉐이킹~!");
	INIDATA->addData("거미 사이다", "체력 회복", "24");
	INIDATA->addData("거미 사이다", "가격", "700");
	INIDATA->iniSave("상점리스트");

	INIDATA->addData("거미 도넛", "설명", "거미 다리를 다 자르고 가운데 구멍을 뚫어서 튀겼다!");
	INIDATA->addData("거미 도넛", "능력", "12");
	INIDATA->addData("거미 도넛", "가격", "400");

	INIDATA->addData("버터스카치 파이", "설명", "상점에서 제일 먹음직스럽게 생겼다. 재료는 모른다!");
	INIDATA->addData("버터스카치 파이", "능력", "5");
	INIDATA->addData("버터스카치 파이", "가격", "250");

	INIDATA->addData("반창고", "설명", "먹을게 대부분인데 반창고 사는 검은 소 없제?");
	INIDATA->addData("반창고", "능력", "10");
	INIDATA->addData("반창고", "가격", "500");

	INIDATA->addData("나이스크림", "설명", "거미를 갈아서 만든 즙과 사이다를 쉐이킹");
	INIDATA->addData("나이스크림", "능력", "15");
	INIDATA->addData("나이스크림", "가격", "550");
