...
HRESULT muffetBattle::init()
{
	...
	_muffetState = new muffetPattern1;
...
void muffetBattle::render()
{
	...
	//_muffet->autoFrameRender(200, 100, _currentFrameX, 0, 20);
	_btUI->render();
}
...
void muffetBattle::addMuffetImage()
{
	...
	ImageManager::GetInstance()->AddFrameImage("muffet", L"머펫이미지/battle muffet.png", 15, 1);
